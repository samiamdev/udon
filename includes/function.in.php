...
$subject_mail = ""._RESET_MAIL_SUB."" ; // ��Ǣ�������� 
...
//��Ǩ�ͺ����� User ��ԧ��������ԧ ������Ѻ�к���Ҫԡ ����Ѻ MAXSITE @V.3
...
//��Ǩ�ͺ�дѺ�ͧ�������к� ������Ѻ�к���Ҫԡ ����Ѻ MAXSITE @V.3
...
function sendmail_welcome($member_id ,$name, $user_name , $pwd_name1, $email ,$home) {
                 ## ��ͤ���㹡��������������ռ����Ѥ���Ҫԡ ##
                ##( �ҡ�� Enter ��鹺�÷Ѵ ��ͤ����ͧ�س�����鹺�÷Ѵ����) ##
global $admin_email ;
$subject_mail = _MAIL_WELCOME; // ��Ǣ�������� 
...
//     $ip2 = '111.222.11.33';
     ...
     // Ẻ��� 1 �� explode
//     list($a, $b, $c, $d) = explode('.', $ip1); // �¡ IP �͡�繵��˹觵�ҧ�
//     echo "$a.$b.xxx.xxx"; // ���Ѿ������ö���͡����Ҩк��͡���˹��˹��ҧ
     
 //    echo '<br />';
     
     // Ẻ��� 2 �� preg_replace ���͡�� 2 �������᷹���������ѧ���� xxx.xxx
 //    echo preg_replace('/([0-9]+\.[0-9]+)\.[0-9]+\.[0-9]+/', '\1<span style="color:red">.xxx.xxx</span>', $ip2);
      
      // Ẻ��� 3 �� preg_replace ᷹�����¡�÷�� block ���е�ǵ�����˹觢ͧ�ѹ
  //    function bockipstr( $ip ) {
  //        preg_match('/([0-9]+\.[0-9]+\.)([0-9\.]+)/', $ip, $ips); // �¡�͡�� 2 ����� ��� 2 ��ѡ˹�� ��� 2 ��ѡ��ѧ
   //       return  $ips[1].preg_replace('/[0-9]/','<span style="color:red">x</span>',$ips[2]); // ᷹������Ţ��ѡ��ѧ���� x ���е��
  //    }
