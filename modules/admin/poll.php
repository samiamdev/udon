...
?>
    <tr <?php echo $ColorFill; ?> >
     ...
     <td align="center">
	 				  <? if($arr['poll']['status']=='0') { echo "<a HREF=?name=admin&file=poll&op=poll_update&action=update&id=".$arr['poll']['id']."&status=1><img src=images/publish_x.png alt='"._ADMIN_ORDER_PUBLISH_OFF."'></a>"; } else { echo "<a HREF=?name=admin&file=poll&op=poll_update&action=update&id=".$arr['poll']['id']."&status=0><img src=images/tick.png alt='�"._ADMIN_ORDER_PUBLISH_ON."'></a>"; };?>
	 </td>
