...
?>
	...
	<td align="center"  valign="top">
				  <? if($arr['block']['status']=='0') { echo "<a HREF=?name=admin&file=block&op=block_update&action=update&id=".$arr['block']['id']."&status=1><img src=images/publish_x.png alt='"._ADMIN_BLOCK_ORDER_PUBLISH_OFF."'></a>"; } else { echo "<a HREF=?name=admin&file=block&op=block_update&action=update&id=".$arr['block']['id']."&status=0><img src=images/tick.png alt='�"._ADMIN_BLOCK_ORDER_PUBLISH_ON."'></a>"; };?>
				  </td>
