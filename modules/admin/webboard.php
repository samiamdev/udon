...
//	echo "<CENTER><B><FONT COLOR=#6600FF\"> ".$arr['ments']['post_name']."</B></FONT><br><font size='1'>����� ".ThaiTimeConvert($arr['ments']['post_date'],"","2")."</font></CENTER>\n";
//} else {
...
//	echo "<td width=\"19%\"><CENTER><B><FONT COLOR=#FF0033\"> ".$arr['ment']['post_name']."</B></FONT><IMG SRC=\"images/human.gif\" BORDER=\"0\" ALIGN=\"absmiddle\"><br><font size='1'>����� ".ThaiTimeConvert($arr['ment']['post_date'],"","2")."</font></CENTER></td>\n";
//				} else {
//	echo "<td width=\"19%\"><CENTER><B><FONT COLOR=#6600FF\"> ".$arr['ment']['post_name']."</B></FONT><br><font size='1'>����� ".ThaiTimeConvert($arr['ment']['post_date'],"","2")."</font></CENTER></td>\n";
//				}
//	}else {
